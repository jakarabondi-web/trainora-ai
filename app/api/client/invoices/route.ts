...
import { listInvoices, organizationForUser } from "../../../../lib/server/client-portal";
...
export async function GET() {
  try {
    ...
    return Response.json({ invoices: await listInvoices(organization.id) }, { headers: { "Cache-Control": "no-store" } });
  } catch (error) {
