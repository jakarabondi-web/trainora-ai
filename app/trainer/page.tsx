...
const trainerNav:[string,[string,string,string][]][]=[
  ...
  ["TASKS",[["My Tasks","▤","#tasks"],["Review Tasks","◫","#feedback"],["Gold Tasks","◆","#gold-tasks"]]],["ASSESSMENTS",[["My Assessments","◇","/apply"],["Results","◎","#application-status"]]],
  ["EARNINGS",[["Overview","$","#earnings"],["Payments","▥","#payments"],["Payout Methods","◎","#payout-methods"]]],["ACCOUNT",[["Profile","♙","#profile"],["Settings","⚙","#settings"],["Notifications","♢","#notifications"]]],["SUPPORT",[["Help Center","?","#support"],["Contact Support","♧","mailto:support@trainora.ai"]]],
];
